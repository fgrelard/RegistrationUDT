 ...
 *
 *=========================================================================*/
#ifndef itkVariationalRegistrationDTSSDFunction_h
#define itkVariationalRegistrationDTSSDFunction_h
...
/** \class itk::VariationalRegistrationDTSSDFunction
 *
...
class VariationalRegistrationDTSSDFunction :
    public VariationalRegistrationFunction< TFixedImage, TMovingImage, TDisplacementField >
{
public:
  ITK_DISALLOW_COPY_AND_ASSIGN(VariationalRegistrationDTSSDFunction);

  /** Standard class type alias. */
  using Self = VariationalRegistrationDTSSDFunction;
  ...
  using WarpedImagePointer = typename Superclass::WarpedImagePointer;
  ...
  * \sa SetTimeStep() */
  typename Superclass::TimeStepType ComputeGlobalTimeStep(void * itkNotUsed(GlobalData)) const override
    ...
    WarpedImagePointer GetWarpedDT() const { return m_WarpedImageDT;}
protected:
  VariationalRegistrationDTSSDFunction();
  ~VariationalRegistrationDTSSDFunction() override {}

  using GlobalDataStruct = typename Superclass::GlobalDataStruct;

  void SetWarpedImage(const WarpedImagePointer&);

  virtual const  WarpedImagePointer GetWarpedImage(void) const override;
...
private:
  ...
  WarpedImagePointer m_WarpedImageDT;
};

} // end namespace itk

#ifndef ITK_MANUAL_INSTANTIATION
#include "itkVariationalRegistrationDTSSDFunction.hxx"
#endif
